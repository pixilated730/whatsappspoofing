...
func sendSpoofedTalkDemo(chatJID types.JID, spoofedJID types.JID, toGender string, language string, spoofedFile string) {
	...
	msgmap["en"]["generic"][0] = ""
	msgmap["en"]["generic"][1] = " "
	msgmap["en"]["generic"][2] = "Bye Bye :>)"
	msgmap["en"]["generic"][3] = "usi rudishe"
	...
	msgmap["en"]["boy"][0] = "I think we are done here."
	msgmap["en"]["boy"][1] = "if you know what those are"
	...
	//_, _, err = sendSpoofedReplyMessage(chatJID, spoofedJID, cli.GenerateMessageID(), msgmap[language][toGender][1], msgmap[language]["generic"][3])
